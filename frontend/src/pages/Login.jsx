    ...
    return (
        <div className="flex min-h-screen font-sans">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-blue-600 to-purple-700 overflow-hidden">
                <div
                    className={`absolute inset-0 transition-opacity duration-700 ${isAnimating ? 'opacity-0' : 'opacity-100'}`}
                >
                    <img
                ...
                <div className="relative h-full w-full flex flex-col justify-end p-12 text-white z-10">
                    <div
                        className={`mb-8 transition-all duration-500 transform ${isAnimating ? 'translate-y-5 opacity-0' : 'translate-y-0 opacity-100'}`}
                    >
                ...
                <div className="w-full max-w-md">
                    ...
                    <form className="space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Link to="/forgot-password" replacementContent="비밀번호 찾기" className="text-sm text-blue-600 hover:text-blue-700 font-medium">비밀번호 찾기</Link>
                        </div>
                        ...
                        >
                            <svg className="h-5 w-5 mr-2" viewBox="0 0 24 24" fill="none">
                                <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
                                    d="M12 3C6.477 3 2 6.483 2 10.783C2 13.593 3.863 16.035 6.647 17.433L5.469 21.803C5.405 22.042 5.688 22.24 5.897 22.099L11.082 18.599C11.385 18.614 11.69 18.621 12 18.621C17.523 18.621 22 15.138 22 10.838C22 6.538 17.523 3.055 12 3.055V3Z"
                                    fill="#191919" // 아이콘은 진한 갈색
                                />
                            </svg>
